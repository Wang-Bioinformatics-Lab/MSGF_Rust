...
- **The UC-derived goldens are not committed either** (since 2026-07-24) — `validation/golden/`
  ...
  regenerated by `validation/reference/build_all_golden.sh`. See `LICENSING.md` and
  `validation/golden/README.md`. A new golden derived from MS-GF+ output must be gitignored too.
