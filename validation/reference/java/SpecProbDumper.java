 ...
 *
 *   scorer  = NewScorerFactory.get(HCD, QEXACTIVE, TRYPSIN, STANDARD); // edge scoring ON
...
public class SpecProbDumper {
    ...
    public static void main(String[] args) throws Exception {
        ...
        NewRankScorer scorer = NewScorerFactory.get(
                ActivationMethod.HCD, InstrumentType.QEXACTIVE, Enzyme.TRYPSIN, Protocol.STANDARD);
        ...
        sb.append(" \"gf_construction\": {")
          .append("\"scorer\": ").append(jstr("NewScorerFactory.get(HCD,QEXACTIVE,TRYPSIN,STANDARD)")).append(", ")
